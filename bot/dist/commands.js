...
export const commands = [
    new SlashCommandBuilder()
        ...
        .addChannelOption((o) => o.setName("vouch_kanal").setDescription("Kanal für Bewertungen nach dem Kauf (DM)").addChannelTypes(ChannelType.GuildText))
        .addStringOption((o) => o.setName("pay_empfaenger").setDescription("Standard-Minecraft-Name für /pay (Standard: y3zz)"))
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption((o) => o.setName("betrag").setDescription("z. B. 5,0M oder 2500000").setRequired(true))
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption((o) => o.setName("text").setDescription("Was der Clan anbietet / Regeln").setRequired(true).setMaxLength(1800)))
        .addSubcommand((s) => s
        .setName("plaetze")
        ...
        .addStringOption((o) => o.setName("bezeichnung").setDescription("z. B. Eintritt, Wöchentliche Abgabe").setRequired(true).setMaxLength(80))
        .addStringOption((o) => o.setName("betrag").setDescription("z. B. 5,0M oder 2000000").setRequired(true)))
